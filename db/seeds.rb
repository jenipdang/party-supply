...
Invitation.create(user_id: 1, party_id: 1, guest_id: 2, attended: true)
Invitation.create(user_id: 2, party_id: 2, guest_id: 1, attended: true)
Invitation.create(user_id: 3, party_id: 3, guest_id: 4, attended: false)
Invitation.create(user_id: 4, party_id: 4, guest_id: 3, attended: true)

puts "🌱 Creating supplies..."
balloon = Supply.create(name: "Balloon", price: 0.10, in_stock: true)
bouncer = Supply.create(name: "Bouncer House", price: 100.50, in_stock: true)
...
Expense.create(party_id: 3, supply_id: 1, quantity: 50)
